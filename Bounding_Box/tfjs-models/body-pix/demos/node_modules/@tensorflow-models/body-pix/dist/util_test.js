...
jasmine_util_1.describeWithFlags('util.toInputResolutionHeightAndWidth', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('raises an error when internalResolution is larger than 1', function () {
        expect(function () {
            util_1.toInputResolutionHeightAndWidth(1.01, 16, [640, 480]);
        }).toThrow();
    });
    it('raises an error when internalResolution is less than 0', function () {
        expect(function () {
            util_1.toInputResolutionHeightAndWidth(-0.01, 16, [640, 480]);
        }).toThrow();
    });
});
